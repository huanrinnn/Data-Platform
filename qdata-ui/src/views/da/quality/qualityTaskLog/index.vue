    ...
    <div class="app-container" ref="app-container">
        ...
        <div class="pagecont-bottom">
            ...
            <el-table stripe v-loading="loading" :data="DppQualityLogList" :default-sort="defaultSort"
                ...
                <el-table-column v-if="getColumnVisibility(7)" :label="td('common.texts.remark')" align="left"
                    prop="remark" min-width="260" :show-overflow-tooltip="{ effect: 'light' }">
                    <template #default="scope">
                        {{ scope.row.remark || '-' }}
                    </template>
                </el-table-column>
                <el-table-column :label="td('common.texts.operation')" v-if="getColumnVisibility(8)" align="center"
...
const columns = ref([
    ...
    { key: 7, label: td('common.texts.remark'), visible: true },
    { key: 8, label: td('common.texts.operation'), visible: true },
]);
