...
import { addDaAsset, updateDaAsset } from "@/api/da/asset/asset";
  ...
  try {
    ...
    if (valid) {
      ...
      if (form.value.id != null) {
        // Existing assets should always go through the standard update path.
        // Keep the edit flow independent from bind-resource logic so renaming
        // an asset does not get routed through another mutation path.
