...
/* Keep the assistant page inside the shell content area and use the shell palette. */
.ai-layout {
  --ai-ink: #17202a;
  --ai-muted: #7c8995;
  --ai-line: #e4e9ee;
...
.ai-layout :deep(.el-container),
.ai-layout :deep(.el-aside),
.ai-layout :deep(.el-main) {
  min-width: 0;
  min-height: 0;
}

.ai-layout :deep(::-webkit-scrollbar) {
  width: 6px;
  height: 6px;
}

.ai-layout :deep(::-webkit-scrollbar-track) {
  background: transparent;
}

.ai-layout :deep(::-webkit-scrollbar-thumb) {
  background: #c7d0d8;
  border-radius: 3px;
}

.ai-layout .detail-container {
  min-width: 0;
  min-height: 0;
  overflow: hidden;
...
.ai-layout .main-container .message-container {
  position: relative;
  height: 100%;
  overflow-y: auto;
  background: var(--ai-panel);
...
.ai-layout .footer-container {
  flex: 0 0 auto;
  border-top: 1px solid var(--ai-line);
  background: var(--ai-panel);
}

.ai-layout .footer-container .prompt-from {
...
.ai-layout .footer-container .prompt-from:focus-within {
  border-color: var(--ai-blue);
  box-shadow: 0 0 0 3px rgba(45, 91, 255, 0.1);
}

.ai-layout .footer-container .prompt-input :deep(.el-textarea__inner) {
  color: var(--ai-ink);
}

.ai-layout .footer-container .prompt-btns {
  padding-top: 6px;
}

.ai-layout .footer-container .prompt-btns .chat-type-tag-doubao,
.ai-layout .footer-container .prompt-btns .model-select :deep(.el-input__wrapper),
.ai-layout .footer-container .prompt-btns .chat-type-select :deep(.el-input__wrapper) {
  border-color: var(--ai-line);
  border-radius: 4px;
}

.ai-layout .footer-container .prompt-btns .chat-type-tag-doubao:hover,
.ai-layout .footer-container .prompt-btns .model-select :deep(.el-input__wrapper):hover,
.ai-layout .footer-container .prompt-btns .chat-type-select :deep(.el-input__wrapper):hover {
  border-color: var(--ai-blue);
}

.ai-layout .footer-container .prompt-btns .icon-light,
.ai-layout .footer-container .prompt-btns .chat-type-icon {
  color: var(--ai-blue);
}

.ai-layout .footer-container .prompt-btns .type-text,
.ai-layout .footer-container .prompt-btns .model-select :deep(.el-input__inner),
.ai-layout .footer-container .prompt-btns .chat-type-select :deep(.el-input__inner) {
  color: var(--ai-ink);
}

.ai-layout .footer-container .prompt-btns .btn-send,
.ai-layout .footer-container .prompt-btns .btn-stop {
  background: var(--ai-blue);
  border-color: var(--ai-blue);
}

.ai-layout .ai-disclaimer {
  color: var(--ai-muted);
}

.ai-layout :deep(.data-scope-config.app-container) {
  border-bottom-color: var(--ai-line);
  background: var(--ai-panel) !important;
}

.ai-layout :deep(.data-scope-config .summary-bar) {
  min-height: 64px;
  padding: 0 20px;
  background: var(--ai-panel);
}

.ai-layout :deep(.data-scope-config .summary-left-col .title-info) {
  gap: 10px;
}

.ai-layout :deep(.data-scope-config .summary-left-col .robot-icon) {
  width: 28px;
  height: 28px;
}

.ai-layout :deep(.data-scope-config .summary-left-col .title) {
  color: var(--ai-ink);
  font-size: 16px;
}

.ai-layout :deep(.data-scope-config .summary-middle-col .dim-tag) {
  width: auto;
  min-width: 78px;
  height: 30px;
  border-radius: 4px;
...
.ai-layout :deep(.data-scope-config .summary-middle-col .summary-form .el-form-item__label) {
  color: var(--ai-muted);
}

.ai-layout :deep(.data-scope-config .scope-input .el-input__wrapper) {
  border: 1px solid var(--ai-line);
  border-radius: 4px;
  box-shadow: none;
}

.ai-layout :deep(.data-scope-config .scope-input.active .el-input__wrapper),
.ai-layout :deep(.data-scope-config .scope-input .el-input__wrapper:hover) {
  border-color: var(--ai-blue);
}

.ai-layout :deep(.data-scope-config .config-panel) {
  border-top: 1px solid var(--ai-line);
  background: #f8fafc;
}

.ai-layout :deep(.data-scope-config .panel-footer) {
  border-top-color: var(--ai-line);
}

.ai-layout :deep(.data-scope-config .el-button--primary) {
  background: var(--ai-blue);
  border-color: var(--ai-blue);
}

.ai-layout :deep(.chat-empty) {
  color: var(--ai-ink);
}

.ai-layout :deep(.chat-empty .center-container .title) {
  color: var(--ai-ink);
  font-size: 22px;
}

.ai-layout :deep(.chat-empty .center-container .subheading) {
  color: var(--ai-muted);
}

.ai-layout :deep(.chat-empty .center-container .footer-container .prompt-from) {
  width: min(676px, calc(100vw - 420px));
  min-height: 124px;
  background: var(--ai-panel);
  border-color: var(--ai-line);
  border-radius: 5px;
...
.ai-layout :deep(.chat-empty .center-container .footer-container .prompt-from:focus-within) {
  border-color: var(--ai-blue);
  box-shadow: 0 0 0 3px rgba(45, 91, 255, 0.1);
}

.ai-layout :deep(.chat-empty .center-container .footer-container .chat-type-tag-doubao),
.ai-layout :deep(.chat-empty .center-container .footer-container .model-select .el-input__wrapper),
.ai-layout :deep(.chat-empty .center-container .footer-container .chat-type-select .el-input__wrapper) {
  border-color: var(--ai-line);
  border-radius: 4px;
}

.ai-layout :deep(.chat-empty .center-container .footer-container .btn-send) {
  background: var(--ai-blue);
  border-color: var(--ai-blue);
}
...
@media (max-width: 900px) {
  ...
  .ai-layout :deep(.chat-empty .center-container .footer-container .prompt-from) {
    width: min(676px, calc(100vw - 340px));
  }
}
...
@media (max-width: 640px) {
  ...
  .ai-layout :deep(.data-scope-config .summary-middle-col) {
