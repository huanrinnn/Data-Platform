...
.chat-list .message .left-text-container {
...
.chat-list .message .left-text-container .left-text {
  color: #33404d;
  font-size: 14px;
}

.chat-list .message .right-text-container .right-text {
...
.chat-list .btn-cus:hover {
  background: #f4f7fa;
}

.chat-list .btn-divider {
  --el-border-color: #e4e9ee;
}
...
.suggested-list :deep(.el-check-tag) {
  border-color: #d8e0e8;
  border-radius: 4px;
  color: #52606d;
}

.suggested-list :deep(.el-check-tag.is-checked) {
  border-color: #2d5bff;
  background: #edf2ff;
  color: #2d5bff;
}
