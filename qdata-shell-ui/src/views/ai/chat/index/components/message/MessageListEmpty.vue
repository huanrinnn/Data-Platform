...
.chat-empty .center-container .title {
  color: #17202a;
}

.chat-empty .center-container .subheading {
  color: #7c8995;
}

.chat-empty .center-container .footer-container .prompt-from {
  background: #ffffff;
  border-color: #e4e9ee;
  border-radius: 5px;
}

.chat-empty .center-container .footer-container .prompt-from:focus-within {
  border-color: #2d5bff;
  box-shadow: 0 0 0 3px rgba(45, 91, 255, 0.1);
}

.chat-empty .center-container .footer-container .btn-send {
  background: #2d5bff;
  border-color: #2d5bff;
}

.chat-empty .center-container .footer-container .chat-type-tag-doubao,
.chat-empty .center-container .footer-container .model-select :deep(.el-input__wrapper),
.chat-empty .center-container .footer-container .chat-type-select :deep(.el-input__wrapper) {
  border-color: #e4e9ee;
  border-radius: 4px;
}

.chat-empty .ai-disclaimer {
  color: #9aa6b2;
}
</style>
