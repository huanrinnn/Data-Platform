...
.conversation-container .btn-new-conversation {
  height: 38px;
  margin-bottom: 12px;
...
.conversation-container .search-input {
  margin-top: 0;
}

.conversation-container .search-input :deep(.el-input__wrapper) {
  border: 1px solid #e4e9ee;
  border-radius: 4px;
  box-shadow: none;
}

.conversation-container .search-input :deep(.el-input__wrapper:hover),
.conversation-container .search-input :deep(.is-focus) {
  border-color: #2d5bff;
}
...
.conversation-container .conversation-list .classify-title {
  padding: 12px 4px 6px;
}

.conversation-container .conversation-list .classify-title .mx-1 {
  color: #7c8995;
  font-size: 12px;
}

.conversation-container .conversation-list .conversation-item {
  height: 38px;
  margin-top: 3px;
}

.conversation-container .conversation-list .conversation {
  min-width: 0;
  height: 38px;
  padding: 0 8px;
  border-radius: 5px;
...
.conversation-container .conversation-list .conversation:hover {
  background: #f4f7fa;
}

.conversation-container .conversation-list .conversation.active {
  background: #edf2ff;
}

.conversation-container .conversation-list .conversation.active .title,
.conversation-container .conversation-list .conversation.active .button-wrapper i {
  color: #2d5bff;
}

.conversation-container .conversation-list .conversation .title {
  max-width: 180px;
  padding: 2px 8px;
  color: #17202a;
  font-size: 13px;
...
.conversation-container .conversation-list .conversation .button-wrapper {
  color: #7c8995;
}

.conversation-container .tool-box {
  left: 12px;
  right: 12px;
  bottom: 12px;
  padding: 8px 10px;
