...
public class DaDatasourceServiceImpl extends ServiceImpl<DaDatasourceMapper, DaDatasourceDO> implements IDaDatasourceService, IDaDatasourceApiService {
    ...
    public void initDatasourceCache() {
        try {
            ...
            // Rebuild both caches from the database so no stale datasource remains.
            redisService.delete("datasource");
            redisService.delete("datasource-old");
            ...
            for (DaDatasourceDO ds : list) {
                ...
                try {
                    ...
                    // Historical datasource connection info for backward compatibility.
                    ...
                    log.info("Stored historical datasource: key={}, value={}", key, ds.getId().toString());
                } catch (Exception e) {
