...
public class DaAssetColumnDO extends BaseEntity {
    ...
    public DbColumn toDbColumn() {
        return DbColumn.builder()
                ...
                .dataLength(this.columnLength == null ? null : String.valueOf(this.columnLength))
                .dataPrecision(this.columnLength == null ? null : String.valueOf(this.columnLength))
                .dataScale(this.columnScale == null ? null : String.valueOf(this.columnScale))
                .colKey("1".equals(this.pkFlag))
                .nullable("0".equals(this.nullableFlag))
                .build();
    }
}
